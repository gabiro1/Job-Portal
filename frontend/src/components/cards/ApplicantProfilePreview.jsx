...
const ApplicantProfilePreview = ({
  ...
  return (
    <div className="fixed inset-0 bg-[rgba(0,0,0,0.2)] bg-opacity-50 flex justify-center items-center p-4 z-50">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors"
            >
