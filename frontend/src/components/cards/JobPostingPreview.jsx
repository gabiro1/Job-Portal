      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
          ...
          <div className="">
            ...
            <div className="relative bg-white px-0 pb-8 border-b border-gray-100">
            ...
            <div className="px-0 pb-8 space-y-8">
                ...
                <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50  to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                    <div className="absolute top-0 roght-0 w-32 h-32 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full -translate-y-16 translate-x-16 "></div>
                    <div className="relative z-10">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="text-sm font-bold md:text-lg text-gray-900">
                                    {
                                        currencies.find(
                        ...
                        <div className="hidden md:flex items-center space-x-2 text-sm text-emerald-700 bg-emerald-100pc-3 py-1 rounded-full">
