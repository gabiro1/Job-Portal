    ...
    <div className='space-y-4'>
      <div className='grid grid-cols-2 gap-4'>
        <div>
          ...
          placeholder='0' 
          min="0" 
          className='w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus: focus:border-blue-300 focus:ring focus:ring-blue-300 focus:ring-opacity-50' 
          value={minSalary || ""} 
