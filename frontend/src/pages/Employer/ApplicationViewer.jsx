...
const ApplicationViewer = () => {
  ...
  const fetchApplication = async ( ) =>{
    try {
      setLoading(true);
      const response = await axiosInstance.get(API_PATHS.APPLICATION.GET_ALL_APPLICATIONS(jobId));
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 pb-8'>
          {Object.keys(groupedApplications).length === 0 ? (
            ...
            <div className='text-center py-16'>
              ...
              <h3 className='mt-4 text-xl font-semibold text-gray-900'>No Applications Available</h3>
                ...
                <div key={job._id} className='bg-white rounded-xl shadow-md overflow-hidden'>
                  ...
                  <div className='bg-gradient-to-r from-blue-500 to-blue-600 py-4'>
                    <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                      <div>
                        <h2 className='text-lg font-semibold text-white ml-5 mt-3 '>
                          {job.title}
                        </h2>
                        <div className='flex flex-wrap items-center gap-4 m-5 mt-3 mb-3 text-blue-100'>
                      ...
                      <div className='bg-white/20 backdrop-blur-sm rounded px-3 py-2 m-5 mt-0 mb-3 '>
                          ...
                          <div className='flex items-center gap-4'>
                            ...
                            <div className='flex-shrink-0'>
                              {application.applicant.avatar ? (
                                <img src={application.applicant.avatar} alt={application.applicant.name} className="h-12 w-12 rounded-full object-cover" />
                              ) : (
                            ...
                            <div className='flex items-center gap-3 mt-4 md:m-0'>
                              ...
                              <button onClick={()=> handleDownloadResume(application.applicant.resume)}
