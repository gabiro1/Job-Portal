...
const JobSeekerDashboard = () => {
  ...
  const fetchJobs = async (filterParams = {}) => {
    try {
      ...
      // Add userId to get saved job status
  ...
  // ✅ FIXED VERSION: Update job status to "Applied" immediately after success
    ...
    <div className='bg-gradient-to-br from-blue-50 via-white to-purple-50'>
      ...
      <div className='min-h-screen mt-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:py-8 '>
          ...
          onClick={() => navigate(`/job/${job._id}`)} // ✅ pass navigate correctly
        />
                  ))}
                </div>
              )}
