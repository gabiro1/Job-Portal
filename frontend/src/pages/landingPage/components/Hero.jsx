  ...
  return (
    <section className=' pt-24 pb-16 bg-white min-h-screen flex items-center'>
                ...
                {/* Sub heading  */}
                 ...
                 >
                   ...
                   >
                    ...
                    whileHover={{scale:1.02}}
                    whileTap={{scale:0.98}}
                    className=' bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-300 hover:shadow-md'
                    onClick={()=>navigate(
                 ...
                 >
                    {
                        stats.map((stat, index) =>(
                             ...
                             >
                                ...
                                <div className='text-sm test-gray-600 font-medium'> {stat.label}</div>
                             </motion.div>
                        ))
                    }
                 </motion.div>
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
            ...
            <div className='absolute bottom-20 w-40 h-40 bg-purple-100 rounded-full blur-3xl opacity-30'/>
